...
import torch
import pickle
from classic_agent_training import Agent
from agent_training import FancySnakeGame

def test_snake(agent,episodes=10,render=True):
    agent.epsilon=0.0
    game=FancySnakeGame(render=render)
...
if __name__=="__main__":
    ...
    test_snake(agent,episodes=5,render=True)
